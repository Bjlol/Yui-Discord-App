  ...
  switch(command[0]) {
    ...
    case 'assistant':
      ...
      request.onload = function() { 
        var responseTexty = JSON.parse(this.responseText).result.fulfillment.speech;
        msg.channel.send(new Discord.RichEmbed().addField(`Odpowiedź dla ${memberN} :`, responseTexty).setColor('RANDOM'))
      }
      request.send();
      break;
    case 'addme':
