            ...
            switch (sub[0]) {
                case 'create':
                    ...
                    let newHero = {
                        ...
                        id: utils.encrypt(msg.guild.id, msg.author.id, Heroes.length + 1)
                    }
                ...
                case 'list':
                    if (sub[1] === 'help') {
                        msg.channel.send(new Discord.RichEmbed().setTitle(`Witaj, ${memberN}`)
                            ...
                            .addField('Dodatkowa pomoc:', `Pokazuje listę twoich bohaterów!`));
                        return;
                    }
                ...
                case 'remove':
                    ...
                    if (contains) {
                        if (pass) {
                            msg.channel.send(`Usunięto postać o id **${sub[1]}**`);
